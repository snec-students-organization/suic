...
<head>
    ...
    background: linear-gradient(rgba(0, 40, 30, .9), rgba(1, 51, 28, 0.9)),
        url('<?php echo e(asset("gallery_images/college/college3.jpg")); ?>');
}
    ...
    <section class="teachers-section">
        ...
        <div class="teacher-container">
            ...
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher4.jpeg')); ?>" alt="">
            ...
            <!-- Teacher 2 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher11.jpeg')); ?>" alt="">
                <div class="teacher-info">
            ...
            <!-- Teacher 3 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher2.JPG')); ?>" alt="">
                <div class="teacher-info">
            ...
            <!-- Teacher 4 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher1.JPG')); ?>" alt="">
                <div class="teacher-info">
                    <h2>Niyas Madani</h2>
                    <h4></h4>
                    <p>
            ...
            <!-- Teacher 5 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher3.jpeg')); ?>" alt="">
                <div class="teacher-info">
            ...
            <!-- Teacher 6 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher10.JPG')); ?>" alt="">
                <div class="teacher-info">
                    <h2>Hasan Faizy</h2>
                    <h4></h4>
                    <p>
            ...
            <!-- Teacher 7 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher7.JPG')); ?>" alt="">
                <div class="teacher-info">
            ...
            <!-- Teacher 8 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher8.jpg')); ?>" alt="">
                <div class="teacher-info">
            ...
            <!-- Teacher 9 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher5.jpeg')); ?>" alt="">
                <div class="teacher-info">
            ...
            <!-- Teacher 10 -->
            <div class="teacher-card">
                <img src="<?php echo e(asset('gallery_images/usthad/teacher6.jpeg')); ?>" alt="">
                <div class="teacher-info">
                    <h2>Rajan Sir</h2>
                    <h4></h4>
                    <p>
...
</html><?php /**PATH H:\Yaseen E A\Coding\html\collage web\resources\views/teachers.blade.php ENDPATH**/ ?>