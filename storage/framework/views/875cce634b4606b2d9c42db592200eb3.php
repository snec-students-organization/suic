<?php $__env->startSection('title', 'Shamsul Ulama Islamic & Arts College'); ?>
...
<section id="courses">
    ...
    <div class="courses-grid">
        <div class="card">
            ...
            <p>A comprehensive integrated curriculum blending classical Islamic studies with university degrees in various disciplines.</p>
        </div>
        <div class="card">
            <h3>Arts & Commerce</h3>
            <p>Pre-university secondary schooling and undergraduate programs in Humanities, English Literature, and Commerce.</p>
        </div>
        <div class="card">
            <h3>Hifz-ul-Quran</h3>
            <p>A specialized department for students who wish to memorize the Holy Quran with proper rules of Tajweed.</p>
        </div>
    </div>
</section>
...
<section class="admission">
    <div class="admission-box">
        ...
        <p>Take the first step towards a bright academic career and spiritual growth. Join Shamsul Ulama Islamic & Arts College.</p>
        <button class="whatsapp-btn-pulse" onclick="window.open('https://wa.me/919747064013?text=I%20am%20interested%20in%20Admission%20enquiry','_blank')">
...
<section id="contact">
    <div class="contact-box">
        ...
        <div class="contact-info">
            ...
            <button class="whatsapp-btn-pulse" onclick="window.open('https://wa.me/919747064013?text=I%20am%20interested%20in%20education%20at%20your%20college','_blank')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel Project\collage web\resources\views/home.blade.php ENDPATH**/ ?>